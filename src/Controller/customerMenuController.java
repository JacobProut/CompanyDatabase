...
public class customerMenuController implements Initializable {
     ...
     * @throws IOException
     */
    @FXML void onActionReturnToMainMenu(ActionEvent event) throws IOException {
        stage = (Stage) ((Button)event.getSource()).getScene().getWindow();
     ...
     * @throws IOException
     */
    public static void returnToCustomerViewList(ActionEvent event) throws IOException {
